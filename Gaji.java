...
public class Gaji extends Pegawai{ 
    ...
    public Gaji(String name, String address, int number, double salary){
        super(name, address, number); //downcasting, karena subclass meng-inheritance dari superclass
        setSalary(salary);
    }

    public void mailCheck() { //polymorphism upcasting, overriding dengan superclass
